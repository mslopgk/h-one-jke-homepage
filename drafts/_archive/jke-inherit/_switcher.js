...
(function () {
  var DRAFTS = [
    ['frontend-design', 'v1', 'Deep Ocean Cinematic'],
    ['frontend-design', 'v2', 'Industrial Editorial'],
    ['frontend-design', 'v3', 'Control Room Blueprint'],
    ['apple-design', 'v1', 'Apple Keynote Dark'],
    ['apple-design', 'v2', 'Apple Light · Spring'],
    ['apple-design', 'v3', 'Chapters · Bento'],
    ['design-taste-frontend', 'v1', '원본 진화형'],
    ['design-taste-frontend', 'v2', '비정형 그리드'],
    ['design-taste-frontend', 'v3', '스플릿 / 챕터'],
    ['impeccable', 'v1', '다크 정제형'],
    ['impeccable', 'v2', '라이트 프리미엄'],
    ['impeccable', 'v3', '챕터형 · anime.js']
  ];
  var SKILL_LABEL = {
  ...
  var h = '';
  h += '<a class="hs-btn hs-home" href="../../../index.html" data-tip="시안 인덱스 (2차)">INDEX · 1차 아카이브</a><span class="hs-sep"></span>';
